...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16786__auto__,writer__16787__auto__,opt__16788__auto__){
return cljs.core._write.call(null,writer__16787__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__19067 = o;
(G__19067[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_19071 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_19071))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_19071)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__16195__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__19074 = jsprops;
(G__19074["defaultValue"] = value);

(G__19074["onChange"] = ((function (G__19074,v,value,on_change){
return (function (p1__19072_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19072_SHARP_);
});})(G__19074,v,value,on_change))
);
...
var vec__19076 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19076,(0),null);
var id = cljs.core.nth.call(null,vec__19076,(1),null);
var class$ = cljs.core.nth.call(null,vec__19076,(2),null);
...
var temp__4427__auto__ = (function (){var G__19078 = cljs.core.meta.call(null,v);
var G__19078__$1 = (((G__19078 == null))?null:reagent.impl.template.get_key.call(null,G__19078));
return G__19078__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__19080_19081 = v;
var G__19080_19082__$1 = (((G__19080_19081 == null))?null:reagent.impl.template.key_from_vec.call(null,G__19080_19081));
var G__19080_19083__$2 = (((G__19080_19082__$1 == null))?null:(jsprops["key"] = G__19080_19082__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__19086 = cljs.core.meta.call(null,argv);
var G__19086__$1 = (((G__19086 == null))?null:reagent.impl.template.get_key.call(null,G__19086));
return G__19086__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__19087 = (((jsprops == null))?{}:jsprops);
(G__19087["key"] = key);
...
var n__17092__auto___19088 = a.length;
var i_19089 = (0);
while(true){
if((i_19089 < n__17092__auto___19088)){
(a[i_19089] = reagent.impl.template.as_element.call(null,(a[i_19089])));
...
var a = cljs.core.into_array.call(null,s);
var n__17092__auto___19091 = a.length;
var i_19092 = (0);
while(true){
if((i_19092 < n__17092__auto___19091)){
var val_19093 = (a[i_19092]);
if((cljs.core.vector_QMARK_.call(null,val_19093)) && ((reagent.impl.template.key_from_vec.call(null,val_19093) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19092] = reagent.impl.template.as_element.call(null,val_19093));

var G__19094 = (i_19092 + (1));
i_19092 = G__19094;
continue;
} else {
}
...
var G__19096 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19096) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19096){
